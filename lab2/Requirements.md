...
@ - Тело змейки (сегмент) /n
<, >, V, A - данными символами обозначается голова змейки, её направление./n
$ - "яблочко" (специальный символ, наступив на который, "Змейка вырастет в размерах") /n
...
| A/Left | Поворот змейки налево или продолжение движения влево |
| D/Right | Поворот змейки направо или продолжение движения вправо |
| S/Down | Поворот змейки вниз или продолжение движения вниз |
| esc | Game over |
